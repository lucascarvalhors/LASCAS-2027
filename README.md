...
Uma pasta `export/` com 6 subpastas, uma por modelo:
...
Para cada uma das 6 pastas de modelo, entre nela e rode:
...
Repita trocando o `--calib-dir`/pasta e o `--tag` para os outros 5 modelos:
- `mlp_pure_tribranch_18cls`
- `mobilenetv3_light_kan_tribranch_18cls`
- `mobilenetv3_light_mlp_tribranch_18cls`
- `tribranch18__kan`
...
## 7. Consolidar os 6 resultados

Depois de rodar os 6 modelos, junte os CSVs (ou saídas) em uma única tabela comparando:
...
- [ ] Rodar os 6 modelos com `--runs 500`
